...
void handle_CS_ENHANCE_BUFF(std::shared_ptr<server_session> session, const GAME::CS_ENHANCE_BUFF& read)
{
    ...
    {
        auto max_hp_per = stat_info->max_hp * 0.1;
    ...
    {
        auto speed_per = stat_info->speed * 0.1;
    ...
    {
        auto bullet_speed_per = stat_info->bullet_speed * 0.1;
    ...
    {
        auto bullet_power_per = stat_info->bullet_power * 0.1;
    ...
    {
        auto bullet_distance_per = stat_info->bullet_distance * 0.1;
    ...
    {
        auto reload_time_per = stat_info->reload_time * 0.1;
