...
public:
    ...
    void volley_fire(bullet::type type, const vector3& pos, const vector3& dir, int count, const std::array<vector3, 4>& dirs);
    void noti_volley_fire(bullet::type type, object_id obj_id, std::array<bullet_id, 4> bullet_obj_ids, const vector3& pos, const vector3& dirs, int count, const std::array<vector3, 4>& bullet_dirs, const std::array<vector3, 4>& sizes, float speed, float distance) const;
